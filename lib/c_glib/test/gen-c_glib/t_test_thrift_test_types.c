        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gint32* key82 = g_new (gint32, 1);
              gint32* val83 = g_new (gint32, 1);
              if ((ret = thrift_protocol_read_i32 (protocol, &*key82, error)) < 0)
                return -1;
              xfer += ret;
              if ((ret = thrift_protocol_read_i32 (protocol, &*val83, error)) < 0)
                return -1;
              xfer += ret;
              if (this_object->thing && key82)
                g_hash_table_insert ((GHashTable *)this_object->thing, (gpointer) key82, (gpointer) val83);
            }
...
t_test_thrift_test_test_map_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    {
      key84 = keys[i];
      val85 = (gint32*) g_hash_table_lookup (((GHashTable *) this_object->thing), (gpointer) key84);

      if ((ret = thrift_protocol_write_i32 (protocol, * key84, error)) < 0)
        return -1;
      xfer += ret;

      if ((ret = thrift_protocol_write_i32 (protocol, * val85, error)) < 0)
        return -1;
      xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gint32* key86 = g_new (gint32, 1);
              gint32* val87 = g_new (gint32, 1);
              if ((ret = thrift_protocol_read_i32 (protocol, &*key86, error)) < 0)
                return -1;
              xfer += ret;
              if ((ret = thrift_protocol_read_i32 (protocol, &*val87, error)) < 0)
                return -1;
              xfer += ret;
              if (this_object->success && key86)
                g_hash_table_insert ((GHashTable *)this_object->success, (gpointer) key86, (gpointer) val87);
            }
...
t_test_thrift_test_test_map_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_success == TRUE) {
    ...
    xfer += ret;
    {
      ...
      {
        key88 = keys[i];
        val89 = (gint32*) g_hash_table_lookup (((GHashTable *) this_object->success), (gpointer) key88);

        if ((ret = thrift_protocol_write_i32 (protocol, * key88, error)) < 0)
          return -1;
        xfer += ret;

        if ((ret = thrift_protocol_write_i32 (protocol, * val89, error)) < 0)
          return -1;
        xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &key90, error)) < 0)
                return -1;
              xfer += ret;
              if (val91 != NULL)
              {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val91, error)) < 0)
                return -1;
              xfer += ret;
              if (this_object->thing && key90)
                g_hash_table_insert ((GHashTable *)this_object->thing, (gpointer) key90, (gpointer) val91);
            }
...
t_test_thrift_test_test_string_map_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    {
      key92 = keys[i];
      val93 = (gchar *) g_hash_table_lookup (((GHashTable *) this_object->thing), (gpointer) key92);

      if ((ret = thrift_protocol_write_string (protocol,  key92, error)) < 0)
        return -1;
      xfer += ret;

      if ((ret = thrift_protocol_write_string (protocol,  val93, error)) < 0)
        return -1;
      xfer += ret;
...
t_test_thrift_test_test_string_map_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_success == TRUE) {
    ...
    xfer += ret;
    {
      ...
      {
        key96 = keys[i];
        val97 = (gchar *) g_hash_table_lookup (((GHashTable *) this_object->success), (gpointer) key96);

        if ((ret = thrift_protocol_write_string (protocol,  key96, error)) < 0)
          return -1;
        xfer += ret;

        if ((ret = thrift_protocol_write_string (protocol,  val97, error)) < 0)
          return -1;
        xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; ++i)
            {
              gint32* _elem98 = g_new (gint32, 1);
              if ((ret = thrift_protocol_read_i32 (protocol, &*_elem98, error)) < 0)
                return -1;
              xfer += ret;
              if (this_object->thing && _elem98)
                g_hash_table_insert ((GHashTable *) this_object->thing, (gpointer) _elem98, (gpointer) _elem98);
            }
            if ((ret = thrift_protocol_read_set_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; ++i)
            {
              gint32* _elem99 = g_new (gint32, 1);
              if ((ret = thrift_protocol_read_i32 (protocol, &*_elem99, error)) < 0)
                return -1;
              xfer += ret;
              if (this_object->success && _elem99)
                g_hash_table_insert ((GHashTable *) this_object->success, (gpointer) _elem99, (gpointer) _elem99);
            }
            if ((ret = thrift_protocol_read_set_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gint32* _elem100 = g_new (gint32, 1);
              if ((ret = thrift_protocol_read_i32 (protocol, &*_elem100, error)) < 0)
                return -1;
              xfer += ret;
              g_array_append_vals (this_object->thing, _elem100, 1);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
t_test_thrift_test_test_list_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    if ((ret = thrift_protocol_write_list_begin (protocol, T_I32, (gint32) (this_object->thing ? this_object->thing->len : 0), error)) < 0)
      return -1;
    xfer += ret;
    for (i101 = 0; i101 < (this_object->thing ? this_object->thing->len : 0); i101++)
    {
      if ((ret = thrift_protocol_write_i32 (protocol, (g_array_index (this_object->thing, gint32, i101)), error)) < 0)
        return -1;
      xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gint32* _elem102 = g_new (gint32, 1);
              if ((ret = thrift_protocol_read_i32 (protocol, &*_elem102, error)) < 0)
                return -1;
              xfer += ret;
              g_array_append_vals (this_object->success, _elem102, 1);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
  ...
  if (this_object->__isset_success == TRUE) {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_I32, (gint32) (this_object->success ? this_object->success->len : 0), error)) < 0)
        return -1;
      xfer += ret;
      for (i103 = 0; i103 < (this_object->success ? this_object->success->len : 0); i103++)
      {
        if ((ret = thrift_protocol_write_i32 (protocol, (g_array_index (this_object->success, gint32, i103)), error)) < 0)
          return -1;
        xfer += ret;
      ...
      case 1:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast104, error)) < 0)
            return -1;
          xfer += ret;
          this_object->thing = (TTestNumberz)ecast104;
          this_object->__isset_thing = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
      ...
      case 0:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast105, error)) < 0)
            return -1;
          xfer += ret;
          this_object->success = (TTestNumberz)ecast105;
          this_object->__isset_success = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              GHashTable * val107 = g_hash_table_new_full (g_int_hash, g_int_equal, g_free, g_free);
              ...
              xfer += ret;
              {
                ...
                for (i = 0; i < size; i++)
                {
                  gint32* key108 = g_new (gint32, 1);
                  gint32* val109 = g_new (gint32, 1);
                  if ((ret = thrift_protocol_read_i32 (protocol, &*key108, error)) < 0)
                    return -1;
                  xfer += ret;
                  if ((ret = thrift_protocol_read_i32 (protocol, &*val109, error)) < 0)
                    return -1;
                  xfer += ret;
                  if (val107 && key108)
                    g_hash_table_insert ((GHashTable *)val107, (gpointer) key108, (gpointer) val109);
                }
              ...
              if (this_object->success && key106)
                g_hash_table_insert ((GHashTable *)this_object->success, (gpointer) key106, (gpointer) val107);
            }
...
t_test_thrift_test_test_map_map_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_success == TRUE) {
    ...
    xfer += ret;
    {
      ...
      {
        key110 = keys[i];
        val111 = (GHashTable *) g_hash_table_lookup (((GHashTable *) this_object->success), (gpointer) key110);

        if ((ret = thrift_protocol_write_i32 (protocol, * key110, error)) < 0)
          return -1;
        xfer += ret;

        {
          ...
          if ((ret = thrift_protocol_write_map_begin (protocol, T_I32, T_I32,  val111 ? (gint32) g_hash_table_size ((GHashTable *)  val111) : 0, error)) < 0)
            return -1;
          xfer += ret;
          if ( val111)
            g_hash_table_foreach ((GHashTable *)  val111, thrift_hash_table_get_keys, &key_list);
          key_count = g_list_length (key_list);
          keys = g_newa (gint32*, key_count);
          for (iter = g_list_first (key_list); iter; iter = iter->next)
            keys[i++] = (gint32*) iter->data;
          ...
          {
            key112 = keys[i];
            val113 = (gint32*) g_hash_table_lookup (((GHashTable *)  val111), (gpointer) key112);

            if ((ret = thrift_protocol_write_i32 (protocol, * key112, error)) < 0)
              return -1;
            xfer += ret;

            if ((ret = thrift_protocol_write_i32 (protocol, * val113, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_i64 (protocol, &*key114, error)) < 0)
                return -1;
              xfer += ret;
              {
                guint32 size;
                ...
                for (i = 0; i < size; i++)
                {
                  ...
                  gint32 ecast118;
                  if ((ret = thrift_protocol_read_i32 (protocol, &ecast118, error)) < 0)
                    return -1;
                  xfer += ret;
                  key116 = (TTestNumberz)ecast118;
                  if ( val117 != NULL)
                  {
                    g_object_unref (val117);
                  }
                  val117 = g_object_new (T_TEST_TYPE_INSANITY, NULL);
                  if ((ret = thrift_struct_read (THRIFT_STRUCT (val117), protocol, error)) < 0)
                  {
                    g_object_unref (val117);
                    return -1;
                  }
                  xfer += ret;
                  if (val115 && key116)
                    g_hash_table_insert ((GHashTable *)val115, (gpointer) key116, (gpointer) val117);
                }
              ...
              if (this_object->success && key114)
                g_hash_table_insert ((GHashTable *)this_object->success, (gpointer) key114, (gpointer) val115);
            }
...
t_test_thrift_test_test_insanity_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_success == TRUE) {
    ...
    xfer += ret;
    {
      TTestUserId* key119 = NULL;
      GHashTable * val120 = NULL;
      GList *key_list = NULL, *iter = NULL;
      TTestUserId** keys;
      int i = 0, key_count;
      ...
      {
        key119 = keys[i];
        val120 = (GHashTable *) g_hash_table_lookup (((GHashTable *) this_object->success), (gpointer) key119);

        if ((ret = thrift_protocol_write_i64 (protocol, * key119, error)) < 0)
          return -1;
        xfer += ret;

        {
          TTestNumberz key121;
          TTestInsanity * val122 = NULL;
          GList *key_list = NULL, *iter = NULL;
          TTestNumberz* keys;
          int i = 0, key_count;

          if ((ret = thrift_protocol_write_map_begin (protocol, T_I32, T_STRUCT,  val120 ? (gint32) g_hash_table_size ((GHashTable *)  val120) : 0, error)) < 0)
            return -1;
          xfer += ret;
          if ( val120)
            g_hash_table_foreach ((GHashTable *)  val120, thrift_hash_table_get_keys, &key_list);
          key_count = g_list_length (key_list);
          keys = g_newa (TTestNumberz, key_count);
          for (iter = g_list_first (key_list); iter; iter = iter->next)
            keys[i++] = (TTestNumberz) iter->data;
          ...
          {
            key121 = keys[i];
            val122 = (TTestInsanity *) g_hash_table_lookup (((GHashTable *)  val120), (gpointer) key121);

            if ((ret = thrift_protocol_write_i32 (protocol, (gint32)  key121, error)) < 0)
              return -1;
            xfer += ret;
  ...
  while (1)
  {
    ...
    switch (fid)
    {
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gint16* key123 = g_new (gint16, 1);
              gchar * val124 = NULL;
              if ((ret = thrift_protocol_read_i16 (protocol, &*key123, error)) < 0)
                return -1;
              xfer += ret;
              if (val124 != NULL)
              {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val124, error)) < 0)
                return -1;
              xfer += ret;
              if (this_object->arg3 && key123)
                g_hash_table_insert ((GHashTable *)this_object->arg3, (gpointer) key123, (gpointer) val124);
            }
      ...
      case 5:
        ...
        {
          gint32 ecast125;
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast125, error)) < 0)
            return -1;
          xfer += ret;
          this_object->arg4 = (TTestNumberz)ecast125;
...
t_test_thrift_test_test_multi_args_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    {
      key126 = keys[i];
      val127 = (gchar *) g_hash_table_lookup (((GHashTable *) this_object->arg3), (gpointer) key126);

      if ((ret = thrift_protocol_write_i16 (protocol, * key126, error)) < 0)
        return -1;
      xfer += ret;

      if ((ret = thrift_protocol_write_string (protocol,  val127, error)) < 0)
        return -1;
      xfer += ret;
