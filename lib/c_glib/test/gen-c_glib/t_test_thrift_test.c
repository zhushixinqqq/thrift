...
gboolean t_test_thrift_test_client_send_test_map (TTestThriftTestIf * iface, const GHashTable * thing, GError ** error)
{
...

  {
    ...
    xfer += ret;
    {
      ...
      {
        key128 = keys[i];
        val129 = (gint32*) g_hash_table_lookup (((GHashTable *) thing), (gpointer) key128);

        if ((ret = thrift_protocol_write_i32 (protocol, * key128, error)) < 0)
          return 0;
        xfer += ret;

        if ((ret = thrift_protocol_write_i32 (protocol, * val129, error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                gint32* key130 = g_new (gint32, 1);
                gint32* val131 = g_new (gint32, 1);
                if ((ret = thrift_protocol_read_i32 (protocol, &*key130, error)) < 0)
                  return 0;
                xfer += ret;
                if ((ret = thrift_protocol_read_i32 (protocol, &*val131, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && key130)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key130, (gpointer) val131);
              }
...
gboolean t_test_thrift_test_client_send_test_string_map (TTestThriftTestIf * iface, const GHashTable * thing, GError ** error)
{
...

  {
    ...
    xfer += ret;
    {
      ...
      {
        key132 = keys[i];
        val133 = (gchar *) g_hash_table_lookup (((GHashTable *) thing), (gpointer) key132);

        if ((ret = thrift_protocol_write_string (protocol,  key132, error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &key134, error)) < 0)
                  return 0;
                xfer += ret;
                if (val135 != NULL)
                {
                ...
                if ((ret = thrift_protocol_read_string (protocol, &val135, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && key134)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key134, (gpointer) val135);
              }
          ...
          {
            {
              ...
              for (i = 0; i < size; ++i)
              {
                gint32* _elem136 = g_new (gint32, 1);
                if ((ret = thrift_protocol_read_i32 (protocol, &*_elem136, error)) < 0)
                  return 0;
                xfer += ret;
                if (*_return && _elem136)
                  g_hash_table_insert ((GHashTable *) *_return, (gpointer) _elem136, (gpointer) _elem136);
              }
...

  {
    ...
    xfer += ret;
    {
      ...
      if ((ret = thrift_protocol_write_list_begin (protocol, T_I32, (gint32) (thing ? thing->len : 0), error)) < 0)
        return 0;
      xfer += ret;
      for (i137 = 0; i137 < (thing ? thing->len : 0); i137++)
      {
        if ((ret = thrift_protocol_write_i32 (protocol, (g_array_index (thing, gint32, i137)), error)) < 0)
          return 0;
        xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                gint32* _elem138 = g_new (gint32, 1);
                if ((ret = thrift_protocol_read_i32 (protocol, &*_elem138, error)) < 0)
                  return 0;
                xfer += ret;
                g_array_append_vals (*_return, _elem138, 1);
              }
    ...
    while (1)
    {
      ...
      switch (fid)
      {
        case 0:
          ...
          {
            gint32 ecast139;
            if ((ret = thrift_protocol_read_i32 (protocol, &ecast139, error)) < 0)
              return 0;
            xfer += ret;
            *_return = (TTestNumberz)ecast139;
          } else {
            if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
              return 0;
            xfer += ret;
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                ...
                GHashTable * val141 = g_hash_table_new_full (g_int_hash, g_int_equal, g_free, g_free);
                ...
                xfer += ret;
                {
                  ...
                  for (i = 0; i < size; i++)
                  {
                    gint32* key142 = g_new (gint32, 1);
                    gint32* val143 = g_new (gint32, 1);
                    if ((ret = thrift_protocol_read_i32 (protocol, &*key142, error)) < 0)
                      return 0;
                    xfer += ret;
                    if ((ret = thrift_protocol_read_i32 (protocol, &*val143, error)) < 0)
                      return 0;
                    xfer += ret;
                    if (val141 && key142)
                      g_hash_table_insert ((GHashTable *)val141, (gpointer) key142, (gpointer) val143);
                  }
          ...
          {
            {
              ...
              for (i = 0; i < size; i++)
              {
                TTestUserId* key144 = g_new (TTestUserId, 1);
                GHashTable * val145 = g_hash_table_new_full (g_direct_hash, g_direct_equal, NULL, g_object_unref);
                if ((ret = thrift_protocol_read_i64 (protocol, &*key144, error)) < 0)
                  return 0;
                xfer += ret;
                {
                  guint32 size;
                  ...
                  {
                    TTestNumberz key146;
                    TTestInsanity * val147 = NULL;
                    gint32 ecast148;
                    if ((ret = thrift_protocol_read_i32 (protocol, &ecast148, error)) < 0)
                      return 0;
                    xfer += ret;
                    key146 = (TTestNumberz)ecast148;
                    if ( val147 != NULL)
                    {
                      g_object_unref (val147);
                    }
                    val147 = g_object_new (T_TEST_TYPE_INSANITY, NULL);
                    if ((ret = thrift_struct_read (THRIFT_STRUCT (val147), protocol, error)) < 0)
                    {
                      g_object_unref (val147);
                      return 0;
                    }
                    xfer += ret;
                    if (val145 && key146)
                      g_hash_table_insert ((GHashTable *)val145, (gpointer) key146, (gpointer) val147);
                  }
                ...
                if (*_return && key144)
                  g_hash_table_insert ((GHashTable *)*_return, (gpointer) key144, (gpointer) val145);
              }
...
gboolean t_test_thrift_test_client_send_test_multi (TTestThriftTestIf * iface, const gint8 arg0, const gint32 arg1, const gint64 arg2, const GHashTable * arg3, const TTestNumberz arg4, const TTestUserId arg5, GError ** error)
{
...

  {
    ...
    xfer += ret;
    {
      ...
      {
        key149 = keys[i];
        val150 = (gchar *) g_hash_table_lookup (((GHashTable *) arg3), (gpointer) key149);

        if ((ret = thrift_protocol_write_i16 (protocol, * key149, error)) < 0)
          return 0;
        xfer += ret;

        if ((ret = thrift_protocol_write_string (protocol,  val150, error)) < 0)
          return 0;
        xfer += ret;
