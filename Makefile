...
am__append_1 = lib/cpp/test
am__append_2 = test
am__append_3 = tutorial
subdir = .
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/config.hin \
	$(top_srcdir)/compiler/cpp/src/thrift/version.h.in \
	$(top_srcdir)/compiler/cpp/src/thrift/generate/t_cpp_generator.cc \
...
am__aclocal_m4_deps = $(top_srcdir)/aclocal/ac_prog_bison.m4 \
	...
	$(top_srcdir)/aclocal/m4_ax_compare_version.m4 \
...
CONFIG_CLEAN_FILES = compiler/cpp/src/thrift/version.h \
...
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) \
	$(LISP)config.hin config.hin config.hin
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = compiler/cpp lib test tutorial lib/cpp lib/cpp/test
...
ACLOCAL = ${SHELL} /root/work/thrift-0.10.0/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
...
ANT_FLAGS = 
AR = ar
AUTOCONF = ${SHELL} /root/work/thrift-0.10.0/missing autoconf
AUTOHEADER = ${SHELL} /root/work/thrift-0.10.0/missing autoheader
AUTOMAKE = ${SHELL} /root/work/thrift-0.10.0/missing automake-1.14
AWK = gawk
BISON = bison
BOOST_CHRONO_LDADD = /usr/lib64/libboost_chrono.a
BOOST_CPPFLAGS = -I/usr/include
BOOST_FILESYSTEM_LDADD = /usr/lib64/libboost_filesystem.a
BOOST_LDFLAGS = -L/usr/lib64
BOOST_LIB_DIR = /usr/lib64
BOOST_SYSTEM_LDADD = /usr/lib64/libboost_system.a
BOOST_TEST_LDADD = /usr/lib64/libboost_unit_test_framework.a
BOOST_THREAD_LDADD = /usr/lib64/libboost_thread.a
...
LUA_SHORT_VERSION = 
LUA_VERSION = 
MAKEINFO = ${SHELL} /root/work/thrift-0.10.0/missing makeinfo
MANIFEST_TOOL = :
MAYBE_CPP = cpp
MAYBE_CSHARP = 
MAYBE_C_GLIB = c_glib
...
QT5_LIBS = 
QT5_MOC = 
QT_CFLAGS = -DQT_SHARED -I/usr/include/QtCore -I/usr/include/QtNetwork  
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /root/work/thrift-0.10.0
abs_srcdir = /root/work/thrift-0.10.0
abs_top_builddir = /root/work/thrift-0.10.0
abs_top_srcdir = /root/work/thrift-0.10.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/work/thrift-0.10.0/install-sh
...
#SUBDIRS = compiler/cpp lib $(am__append_2) \
#	$(am__append_3)

# To enable bootstrap, build order is lib/cpp -> compiler -> others
SUBDIRS = lib/cpp compiler/cpp lib $(am__append_1) \
	$(am__append_2) $(am__append_3)
empty := 
space := $(empty) $(empty)
comma := ,
CROSS_LANGS = cpp c_glib  java  py  rb   php     
...
lib/cpp/src/thrift/config.h: lib/cpp/src/thrift/stamp-h2
	@test -f $@ || rm -f lib/cpp/src/thrift/stamp-h2
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) lib/cpp/src/thrift/stamp-h2
...
lib/c_glib/src/thrift/config.h: lib/c_glib/src/thrift/stamp-h3
	@test -f $@ || rm -f lib/c_glib/src/thrift/stamp-h3
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) lib/c_glib/src/thrift/stamp-h3

lib/c_glib/src/thrift/stamp-h3: $(srcdir)/config.hin $(top_builddir)/config.status
	@rm -f lib/c_glib/src/thrift/stamp-h3
	cd $(top_builddir) && $(SHELL) ./config.status lib/c_glib/src/thrift/config.h

distclean-hdr:
	-rm -f config.h stamp-h1 lib/cpp/src/thrift/config.h lib/cpp/src/thrift/stamp-h2 lib/c_glib/src/thrift/config.h lib/c_glib/src/thrift/stamp-h3
compiler/cpp/src/thrift/version.h: $(top_builddir)/config.status $(top_srcdir)/compiler/cpp/src/thrift/version.h.in
